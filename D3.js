...
console.log("Personaggi con occhi rossi",eyeColor.red);
console.log("Personaggi con occhi Grigio chiario:",eyeColor.blueGray);
/* ESERCIZIO 6
...
let crewMass = 0;
while (crewMass < 5){
  crewMass += Math.random()
  console.log("Ciclo While");
  console.log("Destinazione =", crewMass)
}
console.log("end")
/* ESERCIZIO 7
...
*/
let totalMass = "starWarsCharacters"
if (toalMass <500){
...
console.log("Total Ship Mass", totalMass)
...
while (sstarWarsCharacters < 5)
for (let i = 0; i < starWarsCharacters.length; i++){
  if(charactersNames[i].charAt(0) === "Luke") {
  }
}
console.log("Elimina questo nome", starWarsCharacters[i])
/* --EXTRA-- ESERCIZIO 10
